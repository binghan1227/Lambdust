use crate::church::*;
use crate::{bind_vars, trace_expr, var};
...
pub fn test_succ_zero() {
    ...
    let test = crate::app(church_succ(), church_zero());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_succ_two() {
    ...
    let test = crate::app(church_succ(), church_two());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_add_one_two() {
    ...
    let test = crate::app(crate::app(church_add(), church_one()), church_two());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_add_zero_two() {
    ...
    let test = crate::app(crate::app(church_add(), church_zero()), church_two());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_mult_two_three() {
    ...
    let test = crate::app(crate::app(church_mult(), church_two()), church_three());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_mult_zero_three() {
    ...
    let test = crate::app(crate::app(church_mult(), church_zero()), church_three());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_is_zero_zero() {
    ...
    let test = crate::app(church_is_zero(), church_zero());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_is_zero_one() {
    ...
    let test = crate::app(church_is_zero(), church_one());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
...
pub fn test_is_zero_two() {
    ...
    let test = crate::app(church_is_zero(), church_two());
    let bound = bind_vars(*test);
    trace_expr(bound);
}
